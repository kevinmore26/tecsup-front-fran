                ...
                <div className="login_Form bg-blue-gray-100 px-8 py-6 border border-black rounded-xl shadow-md">
                    ...
                    <div className="mb-3">
                        <textarea
                            ...
                            }} name="description" placeholder="Product Description" rows="5" className=" w-full px-2 py-1 text-black bg-blue-gray-50 border border-black rounded-md outline-none placeholder-gray-600 ">
